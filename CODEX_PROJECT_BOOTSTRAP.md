...
supersedes_for_platform_work:
  ...
  - "PRD_v2.0.md showroom scope for platform features"
  - "PRD_v1.1.md implementation scope for platform features"
---
...
가장 먼저 `PLATFORM_STRATEGY.md`를 읽는다. 이 프로젝트의 목적은 쇼핑몰 구축이 아니라 고객 여정 통합이다.
