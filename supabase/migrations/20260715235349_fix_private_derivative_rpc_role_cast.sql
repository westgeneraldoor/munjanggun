-- The file role is a project enum while the guarded RPC payload is JSON text.
-- Keep the comparison explicit so the transaction works on the deployed schema.
